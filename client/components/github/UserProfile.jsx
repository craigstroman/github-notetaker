    ...
    return (
      <div className="profile-container" data-totalRepos={profile.data.public_repos}>
        ...
        <ul className="list-group">
          {profile.data.login &&
            <li className="list-group-item text-left"><b>Username:</b> {profile.data.login}</li>
          }
          {profile.data.company &&
            <li className="list-group-item text-left"><b>Company:</b> {profile.data.company}</li>
          }
          {profile.data.email &&
            <li className="list-group-item text-left"><b>Email:</b> {profile.data.email}</li>
          }
          {profile.data.location &&
            <li className="list-group-item text-left"><b>Location:</b> {profile.data.location}</li>
          }
          ...
          {profile.data.followers >= 1 &&
            <li className="list-group-item text-left"><b>Followers:</b> {profile.data.followers}</li>
          }
          {profile.data.following >= 1 &&
            <li className="list-group-item text-left"><b>Following:</b> {profile.data.following}</li>
          }
          {profile.data.blog &&
            <li className="list-group-item text-left">
              <b>Blog:</b> <a href={profile.data.blog} rel="noopener noreferrer" target="_blank">{profile.data.blog}</a>
            </li>
          }
        </ul>
      </div>
