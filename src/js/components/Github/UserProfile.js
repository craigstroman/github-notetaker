  ...
  render() {
    return (
      <ul className="list-group">
        ...
        {(this.props.bio.followers !== null && this.props.bio.followers !== 0) && <li className="list-group-item">Followers: {this.props.bio.followers}</li>}
        {(this.props.bio.following !== null && this.props.bio.following !== 0)  && <li className="list-group-item">Following: {this.props.bio.following}</li>}
